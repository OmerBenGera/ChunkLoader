...
import it.flowzz.chunkloader.objects.npc.CustomNPC_1_10_R1;
...
public class Loader_1_10_R1 implements Loader{
    ...
    public void spawnNpc(ChunkLoader chunkLoader, Location location) {
        ...
        CustomNPC npc = new CustomNPC_1_10_R1(server, world, new GameProfile(UUID.randomUUID(), "Loader"), new PlayerInteractManager(world));
