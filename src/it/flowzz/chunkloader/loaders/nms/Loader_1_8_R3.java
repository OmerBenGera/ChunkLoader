...
import it.flowzz.chunkloader.objects.npc.CustomNPC_1_8_R3;
...
public class Loader_1_8_R3 implements Loader {
    ...
    public void spawnNpc(ChunkLoader chunkLoader, Location location) {
        ...
        CustomNPC npc = new CustomNPC_1_8_R3(server, world, new GameProfile(UUID.randomUUID(), "Loader"), new PlayerInteractManager(world));
