...
import it.flowzz.chunkloader.objects.npc.CustomNPC_1_9_R2;
...
public class Loader_1_9_R2 implements Loader{
    ...
    public void spawnNpc(ChunkLoader chunkLoader, Location location) {
        ...
        CustomNPC npc = new CustomNPC_1_9_R2(server, world, new GameProfile(UUID.randomUUID(), "Loader"), new PlayerInteractManager(world));
